                ...
                <div class="swiper main_slide" id="main_slide">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a>
                                <img class="d-none d-md-block" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_01.jpg" alt="" />
                                <img class="d-md-none" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_sp_01.jpg" alt="" />
                            </a>
                            <div class="content left top">
                                <div class="title"></div>
                                <div class="main">전신을 감싸주는 온열 목공간</div>
                                <div class="sub">사우나의 극치를 느껴보세요<br /></div>
                        ...
                        <div class="swiper-slide">
                            <a>
                                <img class="d-none d-md-block" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_02.jpg" alt="" />
                                <img class="d-md-none" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_sp_02.jpg" alt="" />
                            </a>
                            <div class="content left top">
                                <div class="title"></div>
                                <div class="main">전신을 감싸주는 온열 목공간</div>
                        ...
                        <div class="swiper-slide">
                            <a>
                                <img class="d-none d-md-block" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_03.jpg" alt="" />
                                <img class="d-md-none" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/main_slide_sp_03.jpg" alt="" />
                            </a>
                            <div class="content left top">
                                <div class="title"></div>
                                <div class="main">전신을 감싸주는 온열 목공간</div>
